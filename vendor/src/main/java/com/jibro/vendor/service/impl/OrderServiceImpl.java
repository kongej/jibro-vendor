...
import com.jibro.vendor.dto.order.OrderDto;
...
public class OrderServiceImpl implements OrderService {
	...
	/* Api로 받아온 정보 Order 테이블에 insert */
	@Override
	public void insertOrder(OrderApiDto orderApiDto) {
		LOGGER.info("[insertOrder] input orderApiDto : {}", orderApiDto);
		...
		orderDto.setCreatedAt(orderApiDto.getCreatedAt());
